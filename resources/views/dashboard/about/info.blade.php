...
@section('content')
    <div class="col-md-12 mt-2">
        <h1>Information Records</h1>
        <div class="float-end btn-create">
            <a href="{{ route('create-info') }}" class="btn btn-primary float-end my-2">
                <i class="bi bi-plus-circle-dotted"></i> Create Information
            </a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped table-hover table-responsive-md table-responsive-sm">
                    ...
                    <tr>
                        <td>{{ $loop->index + 1 }}</td>
                        <td>{{ $info->detail }}</td>
                        <td><a href="{{ route('edit-info', $info->id )}}"><i class="bi bi-pencil-square"></i></a></td>
                        <td>
